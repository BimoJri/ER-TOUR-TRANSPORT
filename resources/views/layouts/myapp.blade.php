...
<body class="bg-sec-400">
                    ...
                    <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <a href="{{ route('cars') }}">
                                    <div class="group text-center">
                                        <div class="group-hover:cursor-pointer">Paket Wisata</div>
                                        <div
                            ...
                            <li>
                                <a href="{{ route('cars') }}">
                                    <div class="group text-center">
                                        <div class="group-hover:cursor-pointer">Artikel</div>
                                        <div
                                            class="block invisible bg-pr-400 w-8 h-1 rounded-md text-center -bottom-1 mx-auto relative group-hover:visible">
                                        </div>
                                    </div>
                    ...
                    @if (Auth::user()->role == 'admin')
                        ...
                        <div id="dropdown"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                ...
                                <li>
                                    <a class="block px-4 py-2 hover:bg-pr-200 " href="{{ route('logout') }}" onclick="event.preventDefault();
    ...
    @if (Auth::check() && Auth::user()->role == 'admin')
        <footer class="px-4 h-[100px]  sm:p-6 bg-gray-800 flex justify-center items-center">
            <p class="text-gray-100 font-car font-medium text-5xl ">Admin Site</p>
        </footer>
    @else
            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://github.com/BimoJri" class="hover:underline " target='_blank'>Github</a>
                                </li>
                                <li>
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    ...
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://github.com/BimoJri" target='_blank' class="text-gray-500 hover:text-white">
                        ...
                        <a href="https://x.com/Bimojri" target='_blank' class="text-gray-500 hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
